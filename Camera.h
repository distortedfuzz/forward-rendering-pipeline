...
public:
    ...
    Matrix4 camera_transformation();
    Matrix4 ortographic_transformation();
    Matrix4 perspective_transformation();
    Matrix4 viewport_transformation();

    void clipping(Vec4 &p0, Vec4 &p1);
    bool visible(double den, double diff, double &te, double &tl);

    //void backface_culling(Scene& scene);
